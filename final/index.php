...
<html lang="en">
<head>
  <title>Restaurante El Arrancadero | Cd. Juárez</title>
...
<body class="relative alt-font" data-spy="scroll" data-offset="60" data-target=".navbar">
  ...
  <div id="home" class="main-wrapper oh">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                      ...
                      <!--<ul class="dropdown-menu">
                        ...
                        <li><a href="index-3.html">Onepage</a></li>
                        <li><a href="index-4.html">Classic</a></li>
                        <li><a href="index-5.html">Portfolio</a></li>
                        <li class="dropdown-submenu">
                          <a href="index-restaurant.html">Restaurant</a>
                          <i class="fa fa-angle-down dropdown-toggle"></i>
                          <ul class="dropdown-menu">
                            <li><a href="restaurant-about-us.html">About</a></li>
                    ...
                    <li class="dropdown">
                      <a href="#">Portfolio</a><i class="fa fa-angle-down dropdown-toggle" data-toggle="dropdown"></i>
                      <ul class="dropdown-menu">
                        <li class="dropdown-submenu">
                          <a href="#">Classic</a>
                          <i class="fa fa-angle-down dropdown-toggle"></i>
                        ...
                        <li class="dropdown-submenu">
                          ...
                          <i class="fa fa-angle-down dropdown-toggle"></i>
                          <ul class="dropdown-menu">
                            <li><a href="portfolio-5-col-gallery.html">5 Columns</a></li>
                            <li><a href="portfolio-4-col-gallery.html">4 Columns</a></li>
                            <li><a href="portfolio-3-col-gallery.html">3 Columns</a></li>
                            <li><a href="portfolio-2-col-gallery.html">2 Columns</a></li>
                          </ul>
                        </li>
                        <li class="dropdown-submenu">
                    ...
                    <li class="dropdown">
                      <a href="#">Blog</a><i class="fa fa-angle-down dropdown-toggle" data-toggle="dropdown"></i>
                      <ul class="dropdown-menu">
                        <li><a href="blog-standard.html">Standard</a></li>
                        <li><a href="blog-creative.html">Creative</a></li>
                    ...
                    <li class="dropdown">
                      <a href="#">Elements</a><i class="fa fa-angle-down dropdown-toggle" data-toggle="dropdown"></i>
    ...
    <div class="content-wrapper oh">
      ...
      <section class="section-wrap relative uno parallax-section">
        ...
        <div class="parallax" data-stellar-background-ratio="0.2"></div>
      </section> <!-- end opening hours -->
      


      <!-- Slider -->
      <section class="section-wrap featured-works nopadding">
        <div class="container-fluid nopadding">

          <div id="works-slider" class="flickity-slider-wrap">
      ...
      <!--<section class="section-wrap intro" id="intro">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-12 text-center wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">
              <h2 class="intro-heading">
              We Provide Tasty Food to our Valued Customer
              </h2>
              <p class="intro-text mb-0">
                DeoTrendy is a responsive and elegant template with tons of features. Lorem ipsum dolor sit amet, consectetur. Grab this perfect solution. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip awesome.
              </p>
            </div> <!-- end col 
      ...
      <section id="about" class="section-wrap relative arrancadero parallax-section">
        ...
        <section id="all" class="section-wrap nopadding">
          <div class="container-fluid">
            ...
            <div class="row">
              <div id="masonry-grid" class="works-grid no-gutter">
                ...
                <div id="selDesayunos" class="work-item quarter hover-2">
                  <div class="work-container">
                    <div class="work-img">
                ...
                <div id="selEventos" class="work-item quarter hover-2">
                  <div class="work-container">
                    <div class="work-img">
                ...
                <div id="selGaleria" class="work-item quarter hover-2">
                  <div class="work-container">
                    <div class="work-img">
              ...
              <div id="selBebidas" class="work-item quarter hover-2">
                <div class="work-container">
                  <div class="work-img">
...
<div id="modPromociones" class="modalContenedor">
...
<div id="modEventos" class=" modalContenedor">
  <button type="button" class="mfp-close close">×</button>
  <button type="button" class="mfp-arrow mfp-arrow-left mfp-prevent-close ant"></button>
  <div class="mod">
    <div class="modImagen"></div>
  </div>
  <button type="button" class="mfp-arrow mfp-arrow-right mfp-prevent-close sig"></button>
</div>
<div id="modDesayunos" class="modalContenedor">
  <button type="button" class="mfp-close close">×</button>
  <button type="button" class="mfp-arrow mfp-arrow-left mfp-prevent-close ant"></button>
  <div class="mod">
    <div class="modImagen"></div>
...
<div id="modGaleria" class="modalContenedor">
  <button type="button" class="mfp-close close">×</button>
  <button type="button" class="mfp-arrow mfp-arrow-left mfp-prevent-close ant"></button>
  <div class="mod">
    <div class="modImagen"></div>
